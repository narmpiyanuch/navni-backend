...
CREATE TABLE `booking` (
    ...
    `sub_area_station_id` INTEGER NOT NULL,
...
-- AddForeignKey
ALTER TABLE `booking` ADD CONSTRAINT `booking_car_information_id_fkey` FOREIGN KEY (`car_information_id`) REFERENCES `car_information`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `booking` ADD CONSTRAINT `booking_sub_area_station_id_fkey` FOREIGN KEY (`sub_area_station_id`) REFERENCES `sub_area_station`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
