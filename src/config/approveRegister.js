...
const approveRegisterDriverEmail = (emailDriver) => {
                              ...
                              <td class="v-container-padding-padding"
                                ...
                                <div class="v-font-size"
                                  ...
                                  <p style="font-size: 14px; line-height: 170%;"><span
                                      style="font-size: 16px; line-height: 27.2px;">Welcome to Navni Family</span>
                                  </p>
                                </div>
  ...
  let mailOptions = {
    ...
    to: `${emailDriver}`,
    subject: "Welcome to Navni Family",
    html: htmlForm,
  };
...
module.exports = approveRegisterDriverEmail;
